...
paths.templateGlob  = paths.templateSrc + '/**/*.*';
...
gulp.task('templates',['clean:templates'], function(){
  ...
  var context = require('./handlebars-context.json');

  var options = {
      ignorePartials: true, 
      batch : [paths.templateSrc + '/partials']
  };
...
gulp.task('watch', ['build'], function() {
  ...
  gulp.watch(paths.templateGlob, ['templates']);
